...
define('GDEV_ONCE__DIR', untrailingslashit(dirname(__FILE__)));
define('GDEV_RUN_ONCE__URL', plugin_dir_url(__FILE__));
...
class GDev
{
  ...
  public static function plugin_locate_template($template_name, $template_path = '', $default_path = '')
  {
    ...
    if (!$template_path) :
      $template_path = 'gutenberg-dev/views/';
    endif;
  ...
  public static function get_template($template_name, $args = array(), $tempate_path = '', $default_path = '')
  {
    ...
    $template_file = GDev::plugin_locate_template($template_name, $tempate_path, $default_path);
